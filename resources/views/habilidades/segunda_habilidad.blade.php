...
<head>
    ...
    <style>
        ...
        :root {
            ...
            --accent-color: #007bff; /* Un tono azul clásico de tecnología */
        }
    ...
    <div class="card">
        <div class="icon">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1" stroke-linecap="round" stroke-linejoin="round" style="color: var(--accent-color);">
                <path d="M4 7v10c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V7c0-1.1-.9-2-2-2H6c-1.1 0-2 .9-2 2z"></path>
                <path d="M4 7L12 13L20 7"></path>
            </svg>
        </div>
        <h1>Desarrollo Backend</h1>
        <p>
            Tengo experiencia en el <span class="highlight">desarrollo del lado del servidor</span>, construyendo APIs robustas y gestionando bases de datos. Me siento cómodo trabajando con <span class="highlight">Node.js</span> y sistemas de bases de datos como <span class="highlight">SQL y NoSQL</span>.
        </p>
    </div>
